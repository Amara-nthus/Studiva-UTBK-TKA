...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-WvGpgnFe.mjs");
...
const manifest = {
  "0391a6e08109195a884035fd0ef091988b2e00c70ecbecd06c24e3d7725ca9f8": {
    functionName: "getSimulationQuestions_createServerFn_handler",
    importer: () => import("./latihan-soal.functions-CWy1eS1_.mjs")
  },
  "06a20202dcb256a8f7052ce7cd92cbfefccf21496c3bc3fc4ff50b29ec0055a9": {
    functionName: "endStudySession_createServerFn_handler",
    importer: () => import("./study.functions-DB7mxHZz.mjs")
  },
  "14be741f39278dac42d2ae5e542be2065d6964298f3c1d7056caa6e5dacf0d6e": {
    functionName: "analyzeWeakness_createServerFn_handler",
    importer: () => import("./weakness.functions-CEYs8V7s.mjs")
  },
  "1b1aba401a87d4ea8433b2641302d5c984df03ea2ec336621dae8aafd3444b2e": {
    functionName: "toggleForumLike_createServerFn_handler",
    importer: () => import("./forum.functions-CZ-2JME6.mjs")
  },
  "42c10c44ec44c8a564c32660aa78d420b665c7e2c54436c77a58b17bf2cf5269": {
    functionName: "createForumPost_createServerFn_handler",
    importer: () => import("./forum.functions-CZ-2JME6.mjs")
  },
  "57282559122b77d8ed744ef6b56fff4c5a46f6d9722fa006ec68a92af61d8b7e": {
    functionName: "getLatestPsikotes_createServerFn_handler",
    importer: () => import("./psikotes.functions-Cv4eG71V.mjs")
  },
  "5aa53f35defb59d3cb1a0fade1db3841d72a4a5cc85779e77a807b368d931e5f": {
    functionName: "getForumPost_createServerFn_handler",
    importer: () => import("./forum.functions-CZ-2JME6.mjs")
  },
  "5d7d71c9b9bdd1b55c6ad847572abfcdcda5d63a910431b7373bd6fb4b1a6a7f": {
    functionName: "pomodoroCoach_createServerFn_handler",
    importer: () => import("./chatbot.functions-luSOTd5Y.mjs")
  },
  "6c9e564dee4ff44d3266c92a668cc8c9341ca08440f59424aacee6955492946f": {
    functionName: "updateProfile_createServerFn_handler",
    importer: () => import("./studiva.functions-zzPp8tvq.mjs")
  },
  "803dbbc0ac60588fb768dfc7ff4ab2a233d61f823cd2bc6530a89c163a093b32": {
    functionName: "getTodayQuiz_createServerFn_handler",
    importer: () => import("./studiva.functions-zzPp8tvq.mjs")
  },
  "8c6016df94df755859f504c92677f7275e4d40af73762d0905338113191d1474": {
    functionName: "listNotes_createServerFn_handler",
    importer: () => import("./notes.functions-Ii-zltub.mjs")
  },
  "97031b97c3b00aa95e7c2afc09de32de3e01610b2da73c3f7036f9e8c1dd8c6f": {
    functionName: "getNote_createServerFn_handler",
    importer: () => import("./notes.functions-Ii-zltub.mjs")
  },
  "9e635b4f7a75c53efbd09b6a22c6e5a75dcf97e10706dba12740c211401f8e20": {
    functionName: "analyzeNote_createServerFn_handler",
    importer: () => import("./notes.functions-Ii-zltub.mjs")
  },
  "a2fd7609d7d23350befeb957a49b80f8ae744e5139be505d13a1e779b33b5ed2": {
    functionName: "submitDailyQuiz_createServerFn_handler",
    importer: () => import("./studiva.functions-zzPp8tvq.mjs")
  },
  ...
  "af6cc0034ba70c96f8ac12e947d15d1e5cd9ec4f0cf2c3278b0dbe1a20940b91": {
    functionName: "runPsikotes_createServerFn_handler",
    importer: () => import("./psikotes.functions-Cv4eG71V.mjs")
  },
  "b6ae636ddb2f2b82ccd2eb0561b70aa2fc692e9536dda0011b6b73d4630be16a": {
    functionName: "deleteForumPost_createServerFn_handler",
    importer: () => import("./forum.functions-CZ-2JME6.mjs")
  },
  "b6d142b0dd0594be4e97ed924c2cdc536937ce69d58dd56b11a0b82caf0b66a1": {
    functionName: "submitSimulation_createServerFn_handler",
    importer: () => import("./latihan-soal.functions-CWy1eS1_.mjs")
  },
  "bb4a5542eab2054f80c94c705f47d6cd0beb888bd4421dde36bc2e6848b706b2": {
    functionName: "startSimulation_createServerFn_handler",
    importer: () => import("./latihan-soal.functions-CWy1eS1_.mjs")
  },
  "c5ec2db284020eb155a03f69f395ba2fa915320877142f90abbff1569aa4bfc2": {
    functionName: "recordSimulation_createServerFn_handler",
    importer: () => import("./studiva.functions-zzPp8tvq.mjs")
  },
  "d41a2e15d5dbe629bb11de842cee00c990b842ab69d01b2dbecbb04e76589f3c": {
    functionName: "startStudySession_createServerFn_handler",
    importer: () => import("./study.functions-DB7mxHZz.mjs")
  },
  "da71abdc6ae6431af69235c4d91e6fa9853c1b504b4d02e1a7ec6564b464ae15": {
    functionName: "createForumComment_createServerFn_handler",
    importer: () => import("./forum.functions-CZ-2JME6.mjs")
  },
  "dc858e535ac56978d012f65b1be0bb1a2569c859df366b08d446df8b693d808e": {
    functionName: "getLeaderboards_createServerFn_handler",
    importer: () => import("./studiva.functions-zzPp8tvq.mjs")
  },
  "dd75182359418cf683043cc726054a6153b67fe1167893f5821521d4cd904410": {
    functionName: "getStudyLeaderboard_createServerFn_handler",
    importer: () => import("./study.functions-DB7mxHZz.mjs")
  },
  "e0aa0450a1c0bdbcf18dead153206bf1d4710c75fdb8ef6f5f0c4a7d3fb1148a": {
    functionName: "createGuestUser_createServerFn_handler",
    importer: () => import("./studiva.functions-zzPp8tvq.mjs")
  },
  "e4615dc709aecd5028d315516995ac893db90b0812af42fb044152d79a9f6965": {
    functionName: "chatbotReply_createServerFn_handler",
    importer: () => import("./chatbot.functions-luSOTd5Y.mjs")
  },
  "f2a931f0183c680d8c1812d37fc4b22fb873c02ac9f021972915af61a8715608": {
    functionName: "submitNoteQuiz_createServerFn_handler",
    importer: () => import("./notes.functions-Ii-zltub.mjs")
  },
  "f49cecec9b71328a768e68893551c4da00cf336eab2402382e2f3ef406b06f27": {
    functionName: "listForumPosts_createServerFn_handler",
    importer: () => import("./forum.functions-CZ-2JME6.mjs")
  },
  "fcb53f430bdc8976a8b0d3e9f68c6a882963c2a5c4660d6c8c2bdacf8f8d4407": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CnvdVWMk.mjs").then((n) => n.r),
    import("./start-NHwfwu2A.mjs"),
